...
const path = "../../assets/";
const BookCovers = {
  firstBook: { path: (`${path}above-all-else-cover-hires.jpg`),
  title: "Above all else" },
  secondBook: { path: (`${path}alice-greta-reissue-hires.jpg`), title: "Alice greta reissue" },
  thirdBook: { path: (`${path}mocktails-hires.jpg`), title: "Mocktails" },
  fourthBook: { path: (`${path}mothers-journey-hires.jpg`), title: "Mothers journey" }
};
        ...
        <View style={styles.categoryContainer}>
          ...
          <TouchableOpacity style={styles.categoryBtn}>
            <View style={styles.categoryIcon}>
              <FontAwesome name="bookmark" size={35} color='blue' />
            </View>
          ...
          <TouchableOpacity style={styles.categoryBtn}>
            <View style={styles.categoryIcon}>
              <FontAwesome5 name="readme" size={35} color='blue' />
            </View>
          ...
          <TouchableOpacity style={styles.categoryBtn}>
            <View style={styles.categoryIcon}>
              <Entypo name="star" size={35} color='blue' />
            </View>
